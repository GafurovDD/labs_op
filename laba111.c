...
int main()
{
  ...
  friend  test[n];
  init_friend(n, test);
  friend  test1 = {1, "Иван", "Иванов","Иванович",  2000, "Пушкина", 1};
  test[0] = test1;
  friend  test2 = {1, "Петя", "Петров","Петрович",  1999, "Ленина", 1};
  test[1] = test2;
  friend  test3 = {1, "Костя", "Дмитриев","Костенко",  1998, "Гагарина", 1};
  test[2] = test3;
  while(k != 255)
  {
